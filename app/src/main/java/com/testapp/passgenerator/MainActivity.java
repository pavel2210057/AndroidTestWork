...
public class MainActivity extends AppCompatActivity {
    ...
    //Ui components
    public Button btnGenerate, btnCopy, btnSatLib;
    ...
    public void initUI(){
        ...
        btnSatLib = (Button)findViewById(R.id.SatLibBtn);
    ...
    public void buttonClickListeners(){
        ...
        btnSatLib.setOnClickListener(
                (View view) -> {
                    startActivity(
                            new Intent(MainActivity.this, SatLib.class)
                    );
                }
        );
    }
